...
if __name__ == "__main__":
    # Load the dataset
    data_path = "Predicting_Chances_Admission_UCLA_Repo\data\\raw\\Admission.csv"
    ...
    scatter_plot(df,"Predicting_Chances_Admission_UCLA_Repo\\reports\\Scatter_Plot1.png")
    ...
    with open('Predicting_Chances_Admission_UCLA_Repo\\models\\MLP_classifier.pkl', 'wb') as f:
        pickle.dump(MLP, f)
    ...
    loss_curve(loss_values,"Predicting_Chances_Admission_UCLA_Repo\\reports\\loss_curve.png")
    ...
    with open("Predicting_Chances_Admission_UCLA_Repo\\models\\" + best_logistic_regression_model_filename, 'wb') as file:
